  ...
  return (
    <div className="travel-safety-tips">
      <div className={`landing d-flex align-items-center ${language != "ar" ? "landing-en" : ""}`}>
        <h1 className="container">{language == "ar" ? "نصائح حول السفر الآمن إلى مصر" : "Health and safety travel tips"}</h1>
        <div className="shadow-1"></div>
        <div className="shadow-2"></div>
      </div>
      <div className="description mt-5 container">
        <h1 className="mb-3 display-4">{language == "ar" ? "أهم النصائح لقضاء تجربة سفر آمن" : "Travel Advice"}</h1>
        <p>
          {language == "ar"
        ...
        <h1 className="mb-3 display-4">{language == "ar" ? "هل السعودية بلد آمنة؟" : "Is Saudi Safe?"}</h1>
        <p>
          {language == "ar"
        ...
        <h1 className="mb-3 display-4">{language == "ar" ? "تعرف على آخر المستجدات الصحية" : "Stay Informed"}</h1>
        <p>
          {language == "ar"
      ...
      <div className="exploring container">
        <h1 className="mb-3 display-4">{language == "ar" ? "تعرف على المزيد" : "Keep Exploring"}</h1>
      </div>
    </div>
  );
}
