...
function NatureAndAdventure() {
    ...
    const AntiquitiesAndCivilizationPlaces = language == "en" ? [
        ...
        },
        {
            ...
            "description": "Explore the stunning nature in Wadi El Rayan Protectorate, with beautiful waterfalls, blue lakes, and trails for jeep tours and kayaking.",
        ...
        },
        {
            ...
            "description": "Enjoy the breathtaking natural landscapes and hot springs in Hammamat Valley, which are ideal for relaxation and camping trips.",
            "image": "https://egyptsites.files.wordpress.com/2010/09/img_3754.jpg"
        },
        {
            "id": 6,
            "place_name": "Taba Island Reserve",
            "description": "Explore the richness of marine life and the beauty of coral reefs in Taba Island Reserve, with opportunities for diving, snorkeling, and glass-bottom boat rides.",
        ...
        },
        {
            ...
            "description": "Enjoy diving and seeing rich marine life in Bermuda Island Reserve, which includes stunning coral reefs and enchanting submarines.",
        ...
        },
        {
            ...
            "description": "Climb the towering Mount Sinai in Saint Catherine Park, and enjoy the breathtaking natural views and thrilling mountain trips.",
        ...
        },
        {
            ...
            "description": "استمتع بالمناظر الطبيعية الخلابة والحمامات الطبيعية الساخنة في وادي الحمامات، والتي تعتبر مثالية لرحلات الاستجمام والتخييم.",
            "image": "https://egyptsites.files.wordpress.com/2010/09/img_3754.jpg"
        },
        {
            "id": 6,
    ...
    return (
        <>
            ...
            <div className="container mt-5 mb-5">
                ...
                <div className="row">
                    <h1 style={{ fontSize: 50 }}>{language == "en" ? "Discover the Nature of Egypt" : "اكتشف الطبيعة في مصر    "}</h1>
