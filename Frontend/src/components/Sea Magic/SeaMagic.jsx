      ...
      ? [
          {
            ...
            description:
              "Explore the vibrant underwater world of the Red Sea with scuba diving adventures, encountering colorful coral reefs and a variety of marine species.",
            price: 100,
      ...
      : [
          {
            ...
            description:
              "استكشف عالم البحار الحيوي في البحر الأحمر مع مغامرات الغوص، واكتشف الشعاب المرجانية الملونة ومجموعة متنوعة من أنواع الأسماك.",
            price: 100,
            image: "https://www.travelstart.co.za/blog/wp-content/uploads/2020/02/984.jpg",
          },
          {
      ...
      <div className="container mt-5 mb-5">
        ...
        <div className="row mt-5">
          ...
          >
            {beaches.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="card beach-card border-0 shadow w-100 position-relative mb-5">
        ...
        <div className="row mt-5">
          ...
          >
            {sea.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="card sea-card border-0 shadow w-100 position-relative mb-5">
        ...
        <div className="row mt-5">
          ...
          >
            {underwater.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="card underwater-card border-0 shadow w-100 position-relative mb-5">
