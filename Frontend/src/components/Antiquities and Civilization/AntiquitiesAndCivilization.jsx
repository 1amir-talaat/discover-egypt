...
function AntiquitiesAndCivilization() {
    ...
    const AntiquitiesAndCivilizationPlaces = language == "en" ? [
        {
            "id": 1,
        ...
        },
        {
            "id": 2,
            "place_name": "Luxor",
            "description": "Explore the Karnak Temple Complex, Luxor Temple, the Valley of the Kings, and the Valley of the Queens in this ancient city.",
            "image": "https://images.pexels.com/photos/18934723/pexels-photo-18934723/free-photo-of-sphinxes-in-karnak-temple-complex-in-luxor-egypt.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
        },
        {
            "id": 3,
        ...
        },
        {
            ...
            "image": "https://images.pexels.com/photos/15131476/pexels-photo-15131476/free-photo-of-ruins-of-philae-temple.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
        },
        {
            "id": 6,
            "place_name": "Saqqara",
        ...
        },
        {
            ...
            "description": "Visit the mortuary temple of Queen Hatshepsut, known for its striking architecture and location in the cliffs of Deir el-Bahari.",
        ...
        },
        {
            ...
            "description": "Explore the Valley of the Nobles, a necropolis in Luxor known for its beautifully decorated tombs belonging to ancient Egyptian nobles.",
        ...
        },
        {
            ...
            "description": "Visit the double temple of Kom Ombo, dedicated to the crocodile god Sobek and the falcon god Horus, overlooking the Nile River.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/b/bc/Kom_Ombo_Portal_04.jpg"
        },
        {
            "id": 15,
            "place_name": "Temple of Medinet Habu",
            "description": "Explore the Temple of Medinet Habu, dedicated to Ramses III, and admire its well-preserved reliefs and colorful hieroglyphics.",
            "image": "https://www.thefivefoottraveler.com/wp-content/uploads/2020/05/DSC00889-980x653.jpg"
        },
        {
            "id": 16,
            "place_name": "Temple of Luxor",
            "description": "Witness the grandeur of the Temple of Luxor, dedicated to the gods Amun, Mut, and Chons, with its colossal statues and towering obelisks.",
        ...
        },
        {
            ...
            "description": "Discover the ruins of the Greco-Roman city of Medinet Madi, featuring a well-preserved temple dedicated to the crocodile god Sobek.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/6/61/Medinet_Madi_05.JPG"
        },
        {
            "id": 18,
            "place_name": "Tanis",
            "description": "Explore the ancient city of Tanis, known for its archaeological treasures, including the royal tombs and the Great Temple of Amun.",
        ...
        },
        {
            ...
            "description": "Explore the Museum of Islamic Art in Cairo, showcasing a vast collection of Islamic artifacts, including textiles and ceramics.",
        ...
        },
        {
            ...
            "description": "استكشف متحف الفن الإسلامي في القاهرة، الذي يعرض مجموعة واسعة من القطع الأثرية الإسلامية، بما في ذلك النسيج والخزف والمخطوطات.",
            "image": "https://images.museumwnf.org/full/museums/eg/1/1.jpg"
        }
    ];
    return (
        <>
            ...
            <div className="container mt-5 mb-5">
                ...
                <div className="row">
                    <h1 style={{ fontSize: 50 }}>{language == "en" ? "Discover the civilization of Egypt" : "اكتشف حضارة مصر    "}</h1>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-8 mt-3 ">
                                    <div className="card text-start antiquities-card border-0 shadow ">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <p className="card-text" style={{ fontSize: 17, color: "#333333" }}>{item.description}</p>
